        ...
        <div class="bg-secondBackground rounded-lg card mb-6">
          ...
          <div class="space-y-2 text-xs">
            ...
            <div class="flex items-center space-x-2">
              ...
              <span class="text-sm text-secondary">{{
                t("subscriptionModal.removeImageBlur")
              }}</span>
            </div>
            <div class="flex items-center space-x-2">
              <svg
              ...
              <span class="text-sm text-secondary">{{
                t("subscriptionModal.generateImages")
              }}</span>
            </div>
            <div class="flex items-center space-x-2">
              <svg
              ...
              <span class="text-sm text-secondary">{{
                t("subscriptionModal.generateVideos")
              }}</span>
            </div>
            <div class="flex items-center space-x-2">
              <svg
            ...
            <div class="flex items-center space-x-2">
              ...
              <span class="text-sm text-secondary">{{
                t("subscriptionModal.fastResponse")
              }}</span>
            </div>
          </div>
        </div>
